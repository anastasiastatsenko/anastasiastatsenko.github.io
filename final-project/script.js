...
function rewardsProgress() {
    ...
    const rewardsItems = document.querySelectorAll('.rewards-item');
    const rewardText = document.querySelectorAll('.rewardtext');
    const endRewardsSection = document.getElementById('end-rewards'); // Get the end-rewards section
    let spendBtnCount = 0;
    ...
    spendBtn.addEventListener('click', function() {
        ...
        if (spendBtnCount >= 1 && spendBtnCount <= 10) {
            ...
            // Change background image of the end-rewards section
            endRewardsSection.style.backgroundImage = `url(images/spendbg${spendBtnCount}.png)`; // Directly use spendBtnCount
